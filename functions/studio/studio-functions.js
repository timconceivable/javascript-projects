...
function reverseCharacters(str) {
    ...
    if (strType === "number") { revStr = Number(revStr); }
    return revStr;
}
...
console.log(reverseCharacters(num), typeof reverseCharacters(num));
...
function reverseAll(anArray) {
    let newArray = [];
    for (i in anArray.reverse()) {
        newArray[i] = reverseCharacters(anArray[i]);
    }
    return newArray;
}
...
console.log(reverseAll(arrayTest1));
console.log(arrayTest2);
console.log(reverseAll(arrayTest2));
console.log(arrayTest3);
console.log(reverseAll(arrayTest3));
